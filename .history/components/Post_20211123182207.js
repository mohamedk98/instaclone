    ...
    <div className="bg-white my-7 border rounded-sm">
      ...
      <div className="flex justify-between px-4 pt-4">
        <div className="flex space-x-3">
          {hasLiked ? (
            <HeartIconFilled
              className="commentBtn text-red-500"
              onClick={likePost}
            />
          ) : (
            <HeartIcon className="commentBtn" onClick={likePost} />
          )}
      ...
      {likes.length > 0 && <span className='mb-1 font-bold block'>{likes.length} Likes</span>}
